import { SUPPORTED_LANGUAGE_CODES as SUPPORTED_LANG_CODES } from '@trek-family/shared';
...
// SESSION_DURATION controls how long a TREK session (the `trek_family_session` JWT
...
// persistent `trek_family_session` cookie `maxAge`. An unticked login keeps
