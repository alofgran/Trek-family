...
import { systemNoticeDtoSchema, type SystemNoticeDto } from '@trek-family/shared';

// The notice contract lives in @trek-family/shared (single source of truth, shared
