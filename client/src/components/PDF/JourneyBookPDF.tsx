...
import { sanitizeRichTextHtml } from '@trek-family/shared'
...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="cover-footer">Made with TREK FAMILY</div>
  </div>
  ...
  <div class="closing-page">
    <div>
      ...
      <div class="closing-sub">Made with TREK FAMILY · ${new Date().getFullYear()}</div>
    </div>
  </div>
