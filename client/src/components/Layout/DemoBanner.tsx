...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur TREK FAMILY Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the TREK FAMILY Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de TREK FAMILY',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من TREK FAMILY',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo TREK FAMILY',
