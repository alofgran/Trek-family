...
const EVENT_LABEL_KEYS: Record<string, string> = {
  ...
  document_expiry: 'settings.notifyDocumentExpiry',
  age_band_update: 'settings.notifyAgeBandUpdate',
  missing_traveler_transport: 'settings.notifyMissingTravelerTransport',
