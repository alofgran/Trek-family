...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna TREK FAMILY lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna TREK FAMILY',
  ...
  'vacay.inviteHint': 'Undang pengguna TREK FAMILY lain untuk berbagi kalender cuti bersama.',
