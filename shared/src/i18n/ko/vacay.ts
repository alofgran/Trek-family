...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': '공유',
  'vacay.sharingHint': '다른 TREK FAMILY 사용자와 휴가 계획을 공유합니다',
  'vacay.owner': '소유자',
  'vacay.shareEmailPlaceholder': 'TREK FAMILY 사용자 이메일',
  ...
  'vacay.inviteHint': '다른 TREK FAMILY 사용자를 초대하여 통합 휴가 캘린더를 공유하세요.',
