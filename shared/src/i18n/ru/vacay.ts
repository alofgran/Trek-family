...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями TREK FAMILY',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя TREK FAMILY',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя TREK FAMILY для совместного календаря отпусков.',
