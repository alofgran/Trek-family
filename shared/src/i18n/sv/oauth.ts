...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} vill ha åtkomst till ditt TREK FAMILY konto. Logga in först.',
  'oauth.authorize.loginButton': 'Logga in på TREK FAMILY',
  'oauth.authorize.requestLabel': 'Begäran om behörighet',
  'oauth.authorize.requestDescription': 'Den här applikationen begär åtkomst till ditt TREK FAMILY konto.',
