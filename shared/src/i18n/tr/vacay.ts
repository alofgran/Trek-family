...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer TREK FAMILY kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'TREK FAMILY kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir TREK FAMILY kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
