...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti TREK FAMILY',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente TREK FAMILY",
  ...
  'vacay.inviteHint': 'Invita un altro utente TREK FAMILY a condividere un calendario ferie combinato.',
