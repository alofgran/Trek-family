...
const admin: TranslationStrings = {
  ...
  'admin.tabs.aiParsing': 'AI Document Parsing',
  'admin.tabs.audit': 'Audit',
  'admin.stats.users': 'Users',
  'admin.stats.trips': 'Trips',
  'admin.stats.travelers': 'Travelers',
  ...
  'admin.packingTemplates.anyTraveler': 'Any traveler',
  'admin.packingTemplates.ageBand': 'Age band this template is tailored for',
  'admin.ai.title': 'AI Document Parsing',
  'admin.ai.subtitle': 'Configure a third-party AI provider to extract fields from passport/ID/visa/vaccination uploads. Itinerary parsing is separate and runs locally — no key needed.',
  'admin.ai.disclosure': 'When a user chooses to parse a passport, ID card, visa, or vaccination record, that document is sent to the provider configured below for analysis. Leave the provider set to "None" to disable this feature entirely.',
  'admin.ai.provider': 'Provider',
  'admin.ai.providerNone': 'None (disable document parsing)',
  'admin.ai.providerAnthropic': 'Anthropic (Claude)',
  'admin.ai.providerOpenaiCompatible': 'OpenAI / OpenAI-compatible endpoint',
  'admin.ai.apiKey': 'API key',
  'admin.ai.apiKeyHint': 'Stored encrypted. Only sent to the provider you selected above.',
  'admin.ai.baseUrl': 'API base URL',
  'admin.ai.baseUrlHint': 'Use this to point at a self-hosted or local OpenAI-compatible vision model instead of api.openai.com.',
  'admin.ai.model': 'Model',
  'admin.ai.modelHint': 'Must support image/vision input.',
  'admin.ai.saved': 'Saved',
  'admin.tabs.addons': 'Addons',
  'admin.addons.title': 'Addons',
  'admin.addons.subtitle': 'Enable or disable features to customize your TREK FAMILY experience.',
  ...
  'admin.weather.description':
    'TREK FAMILY uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
