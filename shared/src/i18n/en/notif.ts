...
const notif: TranslationStrings = {
  ...
  'notif.document_expiry.title': 'Document expiring soon',
  'notif.document_expiry.text': "{traveler}'s {documentType} for {trip} expires on {expiry}",
  'notif.age_band_update.title': 'Traveler may have aged into a new group',
  'notif.age_band_update.text': '{traveler} is now old enough to be {newType} instead of {oldType} — update in Settings if that\'s right',
  'notif.missing_traveler_transport.title': 'Missing transport booking',
  'notif.missing_traveler_transport.text': '{travelers} may not have transport booked yet for {trip}',
  ...
  'notif.action.view_travelers': 'View Travelers',
