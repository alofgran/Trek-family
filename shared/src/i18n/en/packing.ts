...
const packing: TranslationStrings = {
  ...
  'packing.decreaseQuantity': 'Decrease quantity',
  'packing.increaseQuantity': 'Increase quantity',
  'packing.filterAll': 'All',
  'packing.filterAllStatuses': 'All Statuses',
  'packing.filterAllTravelers': 'All Travelers',
  ...
  'packing.groupByCategory': 'By category',
  'packing.groupByTraveler': 'By traveler',
  'packing.assignToTraveler': 'Assign all to traveler',
  'packing.unassigned': 'Unassigned',
  'packing.templateForTravelers': 'Apply for travelers',
  'packing.templateForAll': 'No traveler (shared)',
  ...
  'packing.templateError': 'Template not found',
  'packing.templateEmpty': 'Template has no items',
  ...
  'packing.myTemplates': 'My Templates',
  'packing.weatherSuggest': 'Weather suggest',
  'packing.weatherSuggestTitle': 'Suggested for the forecast',
  'packing.weatherSuggestNone': 'No weather-based suggestions right now',
  'packing.weatherSuggestAdd': 'Add selected',
  'packing.weatherSuggestAdded': '{count} items added',
  'packing.weatherSuggestError': 'Could not load weather suggestions',
