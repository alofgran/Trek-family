...
const settings: TranslationStrings = {
  ...
  'settings.tabs.travelers': 'Travelers',
  'settings.map': 'Map',
  ...
  'settings.notifyDocumentExpiry': 'Document expiry alerts',
  'settings.notifyAgeBandUpdate': 'Traveler age-group updates',
  'settings.notifyMissingTravelerTransport': 'Missing transport bookings',
  ...
  'settings.about.description':
    'TREK FAMILY is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and TREK FAMILY only reads from it. Turn on to push edits made in TREK FAMILY back to AirTrail.',
