...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами TREK FAMILY',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача TREK FAMILY',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача TREK FAMILY для спільного календаря відпусток.',
