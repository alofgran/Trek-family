...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες TREK FAMILY',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη TREK FAMILY',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη TREK FAMILY για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
