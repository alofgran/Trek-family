...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do TREK FAMILY',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário TREK FAMILY',
  ...
  'vacay.inviteHint': 'Convide outro usuário TREK FAMILY para compartilhar um calendário de férias combinado.',
