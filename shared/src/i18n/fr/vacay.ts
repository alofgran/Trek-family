...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs TREK FAMILY",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur TREK FAMILY",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur TREK FAMILY à partager un calendrier de vacances combiné.',
